<?php
    ...
    $cmd = $con->prepare("UPDATE convenios SET nome_fantasia = :a, nome_empresa = :b, cnpj = :c, email = :d, nome_cont = :e, homepage = :f, telefone = :g, celular = :h, endereco = :i, numero = :j, cep = :k, complemento = :l, cidade = :m, estado = :n WHERE id_convenio = :id");
